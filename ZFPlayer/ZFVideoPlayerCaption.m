...
- (void)parseSubtitleRaw:(NSString *)string
              completion:(void (^)(NSMutableArray *segments, NSMutableArray *invalidSegments))completion
{
    completion(nil, nil);
}
...
- (id)initWithAttributes:(NSDictionary *)attributes {
    self = [super init];
    if (!self) return nil;
    self.languageCode = [attributes valueForKey:@"language_code"];
    self.segments = [attributes valueForKey:@"subtitles"];
